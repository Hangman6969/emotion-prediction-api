...
const DEFAULT_ENDPOINT = "http://localhost:8080/v1/models/distilbert-emotion:predict"

export function EmotionClassifier() {
  const [text, setText] = useState("I am so happy today!")
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        <div className="flex flex-col gap-2">
          ...
          <textarea
            ...
            rows={3}
            placeholder="Type a sentence, e.g. I am so happy today!"
      ...
      {!loading && latest && (
        <div className="rounded-lg border border-border bg-card p-6 text-card-foreground">
          ...
          {latest.error ? (
            ...
            (() => {
              const meta = getEmotionMeta(latest.topLabel)
              return (
            ...
            <div className="mt-2">
              <p className="text-sm text-muted-foreground">
                The server responded, but no emotion label was recognized. Raw output:
              </p>
